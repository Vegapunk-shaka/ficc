...
class Config(object):
    ...
    DUMP_CHANNEL = get_config("DUMP_CHANNEL", "-1001930986503") # Replace with your dump channel's ID

    UPDATES_CHANNEL = get_config("UPDATES_CHANNEL", None) # Without `@` LOL
     # Get these values from my.telegram.org
    #AUTH_USERS = set(
      #  int(x) for x in get_config(
       #     "AUTH_USERS", "1908235162,-1002111440648,-1002192113412,-1002151759335").split()
  #  )
    AUTH_USERS = [1908235162, -1002111440648, -1002192113412, -1002151759335]
# array , simplest method was AUTH_USERS = [] ; AUTH_USERS.append(your telegram id) 🤣
    ...
    TG_BOT_TOKEN = get_config("TG_BOT_TOKEN", "7434287799:AAFt2xlMWYBMzOrMjhQ-9Epx-C-fp0KecbY")
