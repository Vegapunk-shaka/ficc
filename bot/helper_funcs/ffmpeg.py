...
async def convert_video(video_file, output_directory, total_time, bot, message, chan_msg):
    ...
    process = await asyncio.create_subprocess_shell(
          ...
          # stdout must a pipe to be accessible as process.stdout-vf 'drawtext=fontfile=font.ttf:fontsize={size[0]}:fontcolor=white:bordercolor=black@0.50:x=w-tw-10:y=10:box=1:boxcolor=black@0.5:boxborderw=6:text={name[0]}'
